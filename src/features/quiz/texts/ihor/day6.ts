...
export const Day6: QuestionList = [{
    ...
    {
        id: 103,
        question: `Пасажир й сам достеменно не знає локацію – його друзі скинули геолокацію в месенджер, а він поставив її в застосунку Uklon. Приятелі чекають на нього.`,
        answers: [
            {
                id: 1,
                text: 'Далі',

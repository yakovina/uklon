...
import Img from '../../img/scenes/page_02.svg'
...
<p>Що робитимете?</p>`,
    ...
    {
        id: 204,
        question: `Ви доїхали в напруженному мовчанні до пункту призначення й розійшлися не попрощавшись. Такого ви давно не бачили, тож поставили пасажирці 1 зірку, написавши гнівний відгук.`,
        answers: [
            {
                id: 1,
                text: 'Далі >>',
